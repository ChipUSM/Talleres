...
meas tran fall_time Trig  v(Vin) VAL=1.65 RISE=1 TARG v(Vout) VAL=1.65 FALL=1
meas tran rise_time Trig  v(Vin) VAL=1.65 FALL=1 TARG v(Vout) VAL=1.65 RISE=1
...
C {/workspaces/usm-vlsi-tools/shared_xserver/IHP/Talleres/Taller1/inv_hv.sym} -220 50 0 0 {name=x1}
