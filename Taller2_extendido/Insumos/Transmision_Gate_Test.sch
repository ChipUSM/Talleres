...
} -70 -430 0 0 0.25 0.25 {}
T {Editar el script tal de lograr:

- Guardar las resistencias de encendido (1/gds) en los transistores de cada Transmision Gate
- Guardar las tensiones Drain-Source de cada transistor en los Transmision Gates
- Graficar la salida en tandem con la señal de control
- Graficar las resistencias de encendido (un plot para los del TG "X1" y otro para "X2")
- Graficar las tensiones en el canal Vds (un plot para los del TG "X1" y otro para "X2")} -510 580 0 0 0.4 0.4 {}
...
C {devices/code.sym} -420 -40 0 0 {name=Simulation_Script only_toplevel=false value="
.save all
...
*Guardar transconductancias de compuerta Source-Drain 

*Gruardar la tension Drain-source de los Mosfet en el Switch/Transmision-gate

.control

tran 0.1n  400n  

*Convertir en variables transientes (poniendolas post sim "tran") de variables guardadas


*Guardar las resistencias de encendido se guarda como variable 1/gds:



*PLOTS

*Graficar salida en comparacion con la señal de control

*Graficar resistencias de encendido en cada transistor de los TG

*Graficar las diferencias de tension entre Drain y Source en cada MOS de los TG

.endc


"}
C {devices/vsource.sym} 220 -270 0 1 {name=Vin1 value= "sine( 0.5 0.5 50e06)"}
C {devices/vsource.sym} 220 -150 0 1 {name=Vin2 spice_ignore = 0 value="PULSE( 0 \{vdd\} 8e-09  \{TR\} \{TF\} \{T1*D\} \{T1\} 0)"}
C {devices/lab_pin.sym} 220 -240 0 1 {name=p1 sig_type=std_logic lab=Vss}
C {devices/lab_pin.sym} 220 -120 0 1 {name=p2 sig_type=std_logic lab=Vss}
C {devices/lab_pin.sym} 220 -300 0 1 {name=p4 sig_type=std_logic lab=Vin1}
C {devices/lab_pin.sym} 220 -180 0 1 {name=p5 sig_type=std_logic lab=Vin2}
...
C {Simbolo_Support_1.sym} -10 230 0 0 {name=x3}
C {Transmision_Gate.sym} 150 440 0 0 {name=x2}
C {Transmision_Gate.sym} -200 450 0 0 {name=x1
